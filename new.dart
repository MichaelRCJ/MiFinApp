              ...
              child: Column(
                children: [
                  Wrap(
                    ...
                    runSpacing: 12,
                    children: [
                      _QuickAction(icon: Icons.add_card,
                          label: 'Ingresos',
                          color: theme.colorScheme.primary,
                          onTap: () => onChangeTab?.call(1)),
                      _QuickAction(icon: Icons.ssid_chart,
                          label: 'Análisis',
                          color: theme.colorScheme.secondary,
                          onTap: () => onChangeTab?.call(3)),
                      _QuickAction(icon: Icons.receipt,
                          label: 'Gastos',
                          color: Colors.orange,
                  ...
                  _SectionCard(
                      title: 'Historial de gastos', child: _HistoryList()),
                ],
              ),
            ),
          )
            ...
            child: TextButton(
              onPressed: () =>
                  ScaffoldMessenger.of(context).showSnackBar(const SnackBar(
                      content: Text(
                          'Configura tu presupuesto en la pestaña Presupuesto'))),
              child: const Text(
                  'Configura tu presupuesto en la pestaña Presupuesto'),
            ),
          ),
    ...
    return Column(
      children: _items.map((e) {
        return ListTile(
          ...
          subtitle: Text(
              '${_categoryLabel(e.categoria)} • ${_fmtDate(e.fecha)}'),
            ...
            children: [
              Expanded(
                child: Column(
                  ...
                  children: [
                    ...
                    Text(_fmt(_initial), style: const TextStyle(
              ...
              Column(
                ...
                children: [
                  ...
                  const SizedBox(height: 4),
                  Text(_fmt(_spent), style: TextStyle(
                      color: Colors.red.shade700, fontWeight: FontWeight.w700)),
                ],
              ),
              ...
              Column(
                crossAxisAlignment: CrossAxisAlignment.end,
                children: [
                  Text('Sobrante', style: TextStyle(
                      color: Colors.deepOrange.shade700,
                      fontWeight: FontWeight.w700)),
                  const SizedBox(height: 4),
                  Text(_fmt(remaining), style: TextStyle(
                      color: Colors.deepOrange.shade700,
                      fontWeight: FontWeight.w700)),
                ],
              ),
